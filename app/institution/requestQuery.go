...
func GetRequestsObjectsBySelector(requestType, selectorKey, selectorValue string) ([]string, error) {
	...
	requestsData, err := instAccntsChannelClient.QueryRequests("objects", requestType, selectorKey, selectorValue)
...
func GetRequestsPublicIdsBySelector(requestType, selectorKey, selectorValue string) ([]string, error) {
	...
	instAccntsChannelClient := instaccntschannel.CerberusClient{}
	requestsData, err := instAccntsChannelClient.QueryRequests("publicIds", requestType, selectorKey, selectorValue)
...
func GetRequestsByRecipient(queryType, requestType, recipientPublicId string) ([]string, error) {
	...
	instAccntsChannelClient := instaccntschannel.CerberusClient{}
	requestsData, err := instAccntsChannelClient.QueryRequests(queryType, requestType, selectorKey, recipientPublicId)
...
func GetRequestsByRequester(queryType, requestType, requesterPublicId string) ([]string, error) {
	...
	instAccntsChannelClient := instaccntschannel.CerberusClient{}
	requestsData, err := instAccntsChannelClient.QueryRequests(queryType, requestType, selectorKey, requesterId)
...
func GetRequestsByDocumentName(queryType, documentName string) ([]string, error) {
	...
	instAccntsChannelClient := instaccntschannel.CerberusClient{}
	requestsData, err := instAccntsChannelClient.QueryRequests(queryType, requestType, selectorKey, documentName)
...
func GetRequestsByStatus(queryType, requestType, status string) ([]string, error) {
	...
	instAccntsChannelClient := instaccntschannel.CerberusClient{}
	requestsData, err := instAccntsChannelClient.QueryRequests(queryType, requestType, selectorKey, status)
...
func GetRequestObject(idType, id string) (string, error) {
	...
	instAccntsChannelClient := instaccntschannel.CerberusClient{}
	requestData, err := instAccntsChannelClient.QueryRequestData(idType, id)
...
func GetRequestPublicId(id, requestType string) (string, error) {
	...
	instAccntsChannelClient := instaccntschannel.CerberusClient{}
	requestData, err := instAccntsChannelClient.QueryRequestData("requestId", id)
