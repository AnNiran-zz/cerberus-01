...
func CreateAccountDataRequest(requesterPublicId, recipientPublicId string, args []string) (string, []byte, error) {
	...
	_, requestRecord, err := instAccntsChannelClient.CreateAccountDataRequest(newRequestAsBytes, requestDataAsBytes)
...
func CreateDocumentDataRequest(requesterPublicId, recipientPublicId, documentName string, args []string, documentCopy bool) (string, []byte, error) {
	...
	// call chanicode function that sends the request to the data holder
	instAccntsChannelClient := instaccntschannel.CerberusClient{}
	_, requestRecord, err := instAccntsChannelClient.CreateDocumentDataRequest(newRequestAsBytes, requestDataAsBytes)
...
func AcceptAccountDataRequest(recipientPublicId, requestPublicId string, args []string) ([]string, []string, error) {
	...
	// send request
	instAccntsChannelClient := instaccntschannel.CerberusClient{}
	response, record, err := instAccntsChannelClient.AcceptRequest("accountData", requestPublicId, recipientPublicId, acceptedFieldsAsBytes)
...
func AcceptDocumentDataRequest(recipientPublicId, requestPublicId, documentCopy string, args []string) ([]string, []string, []string, error) {
	...
	// send request
	instAccntsChannelClient := instaccntschannel.CerberusClient{}
	response, record, err := instAccntsChannelClient.AcceptRequest("documentData", requestPublicId, recipientPublicId, acceptedFieldsAsBytes)
...
func RejectAccountDataRequest(recipientPublicId, requestPublicId string) ([]string, []string, error) {
	...
	// send request
	instAccntsChannelClient := instaccntschannel.CerberusClient{}
	response, record, err := instAccntsChannelClient.RejectRequest("accountData", requestPublicId, recipientPublicId)
...
func RejectDocumentDataRequest(recipientPublicId, requestPublicId string) ([]string, []string, error) {
	...
	// send request
	instAccntsChannelClient := instaccntschannel.CerberusClient{}
	response, record, err := instAccntsChannelClient.RejectRequest("documentData", requestId, recipientPublicId)
